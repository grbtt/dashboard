...
app.layout = html.Div([
    html.H1('IST Civil Pav Energy Forecast tool'),
    html.P('Representing Data, Forecasting and error metrics for year 2019'),
...
def render_content(tab):
    if tab == 'tab-1':
        return html.Div([
            html.H4('IST Civil Pav Raw Data'),
        ...
        return html.Div([
            html.H4('IST Civil Pav Electricity Forecast (kWh)'),
        ...
        return html.Div([
            html.H4('IST Civil Pav Electricity Forecast Error Metrics'),
            dcc.Dropdown(
                id='metrics-selector',
